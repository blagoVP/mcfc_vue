    ...
    <div class="container d-flex flex-column flex-md-row justify-content-between">
      <router-link class="py-2" to="/home">
        <svg
          ...
          role="img"
          viewBox="0 0 70.617 70.617"
          focusable="false"
        >
          <title>The Trekking Zone</title>
          <path
            style="fill:rgb(248, 212, 8);"
            d="M70.031,46.254L51.69,27.912c-0.78-0.781-2.047-0.781-2.828,0l-7.281,7.28L28.028,21.639
